...
42,307 truck-level delivery records from a petroleum distribution terminal's ERP system, 2015 to 2023, reduced to 14 leakage-free features. Random Forest predicted delay risk at 0.8084 AUC with 0.74 recall, held up by paired bootstrap with confidence intervals and five-fold cross-validation.

The discrete-event simulation is where it gets interesting. At saturation, priority scheduling removes no waiting at all, it only decides who waits: high-risk trucks fell from 1,564 to 509 minutes, a 67.5% cut, while low-risk trucks rose 44.3%. Sweeping the arrival rate located where the policy actually pays: a net benefit ratio peaking at 1.84 around 100% of bay capacity, dropping to 1.14 at 150%.
